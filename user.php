            ...
            <div class="container-right">
                <div class="container">
                    <div class="row my-2">
                        ...
                        <div class="row my-2">
                            <div class="col-md">
                                <a data-bs-toggle="modal" href="#modalTambah" role="button" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah User</a>
                            </div>
                        </div>
                    <div class="row my-3">
                        <div class="col-md">
                                ...
                                <tbody>
                                    ...
                                    <div class="modal fade" id="modalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="staticBackdropLabel">Form Data User</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="tnama" class="form-control" placeholder="Masukkan Nama User" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Password User</label>
                                                        <input type="text" name="tpassword" class="form-control" placeholder="Masukkan Password User" required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="trole" required>
                                                            <option value="" disabled selected hidden>Pilih</option>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary" name="btambahU">Tambah</button>
                                    ...
                                    <div class="modal fade" id="modalEdit<?= $row['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <input type="hidden" name="id" value="<?=$row['id']?>">
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Nama User</label>
                                                                        <input type="text" name="tnama" class="form-control" value="<?=$row['name']?>" placeholder="Masukkan Nama User" required>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="form-label">Password User</label>
                                                                        <input type="text" name="tpassword" class="form-control" value="" placeholder="Masukkan Password User" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Role</label>
                                                                        <select class="form-select" name="trole" required>
                                                                            <option value="<?=$row['role']?>" selected="selected" hidden="hidden"><?=$row['role'];?></option>
                                                                            <option value="Admin">Admin</option>
                                                                            <option value="OP">OP</option>
                                                                        </select>
                                                                    </div>                                                   
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary" name="beditU">Edit</button>
                                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
                                                    </div>
                                                    </form> 
                                                    </div>
                                        ...
                                        <div class="modal fade" id="modalDelete<?= $row['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="staticBackdropLabel">Konfirmasi Delete User</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <h5 class="text-center">Apakah anda yakin akan menghapus User ini?<br>
                                                                <span class="text-danger"><?=$row['name']?></span>
                                                                </h5>
                                                            </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary" name="bdeleteU">Ya,Hapus saja</button>
