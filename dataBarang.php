...
if($_SESSION['session_roles'] == 'OP'){
    ...
    mysqli_query($koneksi,"UPDATE inventory SET facultyId=(SELECT facultyId FROM room WHERE inventory.roomId=room.id)");
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="tjumlah" value="<?=$row['amount']?>" class="form-control" placeholder="Masukkan Jumlah Barang" min="1" required>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div style="display:flex; flex-direction:column;"class="mb-3">
                                                            ...
                                                            <input type="text" name="tlokasi" value="<?=$row['room']?>" class="form-control" placeholder="Masukkan Lokasi Barang" required>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="tharga" value="<?=$row['price']?>" class="form-control" placeholder="Masukkan Harga Barang" min="0" required>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="mb-3">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label class="form-label">Jumlah Barang</label>
                                                            <input type="number" name="tjumlah" class="form-control" placeholder="Masukkan Jumlah Barang" min="1" required>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label class="form-label">Harga</label>
                                                            <input type="number" name="tharga" class="form-control" min="0" placeholder="Masukkan Harga Barang" required>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3">
